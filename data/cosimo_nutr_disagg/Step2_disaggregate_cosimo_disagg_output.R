...
datadir1 <- "data/cosimo/processed"
datadir2 <- "data/cosimo_nutr_disagg/processed"
plotdir <- "data/cosimo/figures"

# Read COSIMO output
cosimo_orig <- readRDS(file.path(datadir2, "COSIMO_nutrient_by_scenario_cntry_with_dissagg.rds"))
...
# Build key
data <- cosimo_orig %>% 
  # Remove original intake and difference
...
# Export
saveRDS(data1, file=file.path(datadir2, "COSIMO_2010_2030_country_nutrient_age_sex_means_and_distributions_with_disagg.Rds"))
