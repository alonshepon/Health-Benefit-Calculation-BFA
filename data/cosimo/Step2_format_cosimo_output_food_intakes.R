...
# Read data
food_lo_orig <-read.csv(file.path(inputdir, "FoodConsBaseRev3.csv"), as.is=T, skip=1)
food_hi_orig <- read.csv(file.path(inputdir, "FoodConsScenRev3.csv"), as.is=T, skip=1)
