...
# Read data
data_orig <- readRDS(file=file.path(outputdir, "2030_ndeficient_base_high.Rds"))
...
# Explort plot
ggsave(g, filename=file.path(plotdir, "FigSX_nutrient_deficiency_maps.png"), 
...
ggsave(plot2, filename=file.path(plotdir, "FigSX_nutrient_deficiency_maps_raster.png"), 
