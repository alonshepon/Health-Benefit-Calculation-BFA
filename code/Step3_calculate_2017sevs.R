...
# Export
write.csv(sev_mn_final, file=file.path(outputdir, "2017_sevs_base_high_road_micronutrients.csv"), row.names=F)
...
# Export
write.csv(sev_omega_final, file=file.path(outputdir, "2017_sevs_base_high_road_omega3s.csv"), row.names=F)
