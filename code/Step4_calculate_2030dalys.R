...
omega <- dalys_fish_orig %>% 
  ...
  left_join(pop, by=c("location_name", "year"="year_id", "age"="age_group_id", "sex"="sex_id")) %>%  # THIS ADDS ROWS SO SOMETHING IS WRONG 
  # Rename columns
