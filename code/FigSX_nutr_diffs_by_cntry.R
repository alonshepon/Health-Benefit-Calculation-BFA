...
# Plot maps
g1 <- plot_map(nutrient="Omega-3 fatty acids", scenario = "High")
g2 <- plot_map(nutrient="Vitamin B12", scenario = "High")
g3 <- plot_map(nutrient="Iron", scenario = "High")
g4 <- plot_map(nutrient="Zinc", scenario = "High")
g5 <- plot_map(nutrient="Calcium", scenario = "High")
g6 <- plot_map(nutrient="Vitamin A", scenario = "High")
