...
# Read data
dalys <- readRDS(file.path(outputdir, "2030_dalys_base_high_road_summarized_diversity_disagg.Rds"))
...
# Export
ggsave(g1, filename=file.path(plotdir, "Fig5_dalys_diversity_disagg.png"), 
