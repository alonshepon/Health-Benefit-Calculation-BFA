...
plot_map <- function(nutrient, inset){
...
# Maps
map1c <- plot_map(nutrient="DHA+EPA fatty acids", inset="Carib")
map2c <- plot_map(nutrient="Vitamin B12", inset="Carib")
map3c <- plot_map(nutrient="Iron", inset="Carib")
map4c <- plot_map(nutrient="Zinc", inset="Carib")
map5c <- plot_map(nutrient="Calcium", inset="Carib")
map6c <- plot_map(nutrient="Vitamin A, RAE", inset="Carib")

map1p <- plot_map(nutrient="DHA+EPA fatty acids", inset="Pacific")
map2p <- plot_map(nutrient="Vitamin B12", inset="Pacific")
map3p <- plot_map(nutrient="Iron", inset="Pacific")
...
# Export plot
ggsave(g, filename=file.path(plotdir, "Fig2_nutrients_insets.png"), 
