...
# Export
write.csv(sev_mn_final, file=file.path(outputdir, "2017_sevs_base_high_road_micronutrients_diversity_disagg.csv"), row.names=F)
...
# Export
write.csv(sev_omega_final, file=file.path(outputdir, "2017_sevs_base_high_road_omega3s_diversity_disagg.csv"), row.names=F)
...
# 
# # Build data required for micronutrient SEV calculations
# data_sev_meat_1cause <- dists2017_meat %>% 
#   # Reduce to age groups with required data
#   filter(age_id>=10)
# 
...
# 
# # Export
# write.csv(sev_meat_final, file=file.path(outputdir, "2017_sevs_base_high_road_meat.csv"), row.names=F)
